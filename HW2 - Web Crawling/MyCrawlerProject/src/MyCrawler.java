...
public class MyCrawler extends WebCrawler {
    String newsURL = "://www.nytimes.com/";
    ...
    public void visit(Page page) {
        ...
        try
        {
            synchronized (this){
                ...
                if( (Pattern.compile(".*(\\.(html|pdf|gif|jpeg|png|doc))$").matcher(url).matches()  && (contentType.matches("(.*)application/json(.*)") || contentType.matches("(.*) application/rss+xml(.*)") ) )  || contentType.matches("(.*)text/html(.*)") ||contentType.matches("(.*)image/png(.*)") || contentType.matches("(.*)image/jpeg(.*)") || contentType.matches("(.*)image/gif(.*)") || contentType.matches("(.*)application/pdf(.*)"))
                {
